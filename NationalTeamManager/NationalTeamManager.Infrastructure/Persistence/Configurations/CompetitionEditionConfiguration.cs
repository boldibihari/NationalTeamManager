...
{
    public class CompetitionEditionConfiguration : IEntityTypeConfiguration<CompetitionEdition>
    {
        public void Configure(EntityTypeBuilder<CompetitionEdition> builder)
        {
