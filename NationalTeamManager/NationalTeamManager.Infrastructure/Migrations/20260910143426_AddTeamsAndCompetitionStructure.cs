...
namespace NationalTeamManager.Infrastructure.Migrations
{
    ...
    public partial class AddTeamsAndCompetitionStructure : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_Players_Clubs_ClubId", table: "Players");

            migrationBuilder.DropTable(name: "Clubs");

            migrationBuilder.DropColumn(name: "IsHome", table: "Matches");

            migrationBuilder.DropColumn(name: "Opponent", table: "Matches");

            migrationBuilder.RenameColumn(name: "ClubId", table: "Players", newName: "TeamId");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_Matches_Teams_AwayTeamId", table: "Matches");

            migrationBuilder.DropForeignKey(name: "FK_Matches_Teams_HomeTeamId", table: "Matches");

            migrationBuilder.DropForeignKey(name: "FK_Players_Teams_TeamId", table: "Players");

            migrationBuilder.DropTable(name: "CompetitionStages");

            migrationBuilder.DropTable(name: "Teams");

            migrationBuilder.DropTable(name: "CompetitionEditions");

            migrationBuilder.DropIndex(name: "IX_Matches_AwayTeamId", table: "Matches");

            migrationBuilder.DropIndex(name: "IX_Matches_CompetitionEditionId", table: "Matches");

            migrationBuilder.DropIndex(name: "IX_Matches_CompetitionStageId", table: "Matches");

            migrationBuilder.DropColumn(name: "AwayScore", table: "Matches");

            migrationBuilder.DropColumn(name: "AwayTeamId", table: "Matches");

            migrationBuilder.DropColumn(name: "CompetitionEditionId", table: "Matches");

            migrationBuilder.RenameColumn(name: "TeamId", table: "Players", newName: "ClubId");
